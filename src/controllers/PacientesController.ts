...
class PacienteController {
  static async allPacientes(req: Request, res: Response) {
    try {
      const pacientes: Array<PacienteInterface> =
        await PacienteService.getPacientes();
      ...
      if (pacientes.length <= 0) {
        ...
        return res
          ...
          .json({
            success: false,
            msg: MESSAGE.ERROR.PACIENTES.NONE_PACIENTE_UNTIL_NOW,
          });
      } else {
        ...
        return res
          ...
          .json({
            success: true,
            msg: MESSAGE.SUCCESS.PACIENTES.PACIENTES_FIND,
            data: pacientes,
          });
      }
    } catch (error: any) {
    ...
    try {
      ...
      if (!paciente) {
        ...
        return res
          ...
          .json({
            success: false,
            msg: MESSAGE.ERROR.PACIENTES.PACIENTE_NOT_FOUND,
          });
      } else {
  ...
  static async create(req: Request, res: Response) {
    ...
    try {
      ...
      return res
        ...
        .json({
          success: true,
          msg: MESSAGE.SUCCESS.PACIENTES.PACIENTES_CREATE,
          data: paciente,
        });
    } catch (error) {
      Logger.error(error);
    ...
    try {
      ...
      if (!paciente) {
        ...
        return res
          ...
          .json({
            success: true,
            msg: MESSAGE.SUCCESS.PACIENTES.PACIENTES_UPDATE,
            data: pacienteObj,
          });
      }
    } catch (error) {
    ...
    try {
      ...
      if (!paciente) {
        ...
        return res
          ...
          .json({
            success: true,
            msg: MESSAGE.SUCCESS.PACIENTES.PACIENTES_DELETE,
          });
      }
    } catch (error) {
      Logger.error(error);
