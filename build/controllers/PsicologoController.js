        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (psicologos.length <= 0) {
                    ...
                    return res
                        .status(200)
                        .json({ success: false, msg: messages_1.default.ERROR.PSICOLOGOS.NONE_PSICOLOGO_UNTIL_NOW });
                }
                else {
                    logger_1.default.info(messages_1.default.SUCCESS.PSICOLOGOS.PSICOLOGOS_FIND);
                    return res
                        .status(200)
                        .json({ success: true, msg: messages_1.default.SUCCESS.PSICOLOGOS.PSICOLOGOS_FIND, data: psicologos });
                }
                ;
            }
            catch (error) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!psicologo) {
                    ...
                    return res
                        .status(500)
                        .json({ success: false, msg: messages_1.default.ERROR.PSICOLOGOS.PSICOLOGO_NOT_FOUND });
                }
                else {
    ...
    static create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return res
                    .status(200)
                    .json({ success: true, msg: messages_1.default.SUCCESS.PSICOLOGOS.PSICOLOGOS_CREATE, data: psicologo });
            }
            catch (error) {
                logger_1.default.error(error);
                return res
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!psicologo) {
                    ...
                    return res.status(200).json({ success: true, msg: messages_1.default.SUCCESS.PSICOLOGOS.PSICOLOGOS_UPDATE, data: psicologoObj });
                }
            }
            catch (error) {
                logger_1.default.error(error);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!psicologo) {
                    ...
                    return res.status(200).json({ success: true, msg: messages_1.default.SUCCESS.PSICOLOGOS.PSICOLOGOS_DELETE });
                }
            }
            catch (error) {
                logger_1.default.error(error);
